...
این گزینه برای تنظیم پروتکل مورد استفاده برای نمایش محتوا و ترافیک غیر حساس است.
...
- **حالت CDN Over OpenVPN** : با تنظیم این گزینه روی حالت **CDN Over OpenVPN** دیتای غیر گیمینگ و محتوای غیر حساس نیز از کانکشن **OpenVPN** عبور کند. با فعال کردن این گزینه کلیه ترافیکی که ایزی پینگ بر روی آن اثر میگذارد و باعث رفع تحریم آن می شود، از حالت **Multi Internet** استفاده کرده و از تمامی اینترنت های متصل به سیستم عبور می کند. 
