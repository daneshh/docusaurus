...
این نرم افزار از فناوری های متنوعی مانند **Network Layer Routing** و **App Layer Packet Modification** و **DNS** اختصاصی و چندید تکنولوژی انحصاری استفاده کرده و از پلتفرم رسمی و متن باز **[OpenVPN](https://openvpn.net/)** به عنوان زیرساخت اصلی استفاده می کند.
