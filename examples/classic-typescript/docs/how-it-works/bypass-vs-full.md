...
در سرویس رفع تحریم **[EZPing](https://ezping.ir/)**، بیشتر سرویس ها و بازی ها دارای دو حالت اتصال **Bypass** و **Full** هستند. شما می توانید با استفاده از گزینه جلوی هر سرویس یا بازی، حالت اتصال آن را نیز تعیین کنید.
