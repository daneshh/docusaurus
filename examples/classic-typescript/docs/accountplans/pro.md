...
پلن **Pro** مناسب دسته خاصی از گیمر ها است که حتی کوچک ترین **لگ و Disconnect** در نتیجه بازی آن ها بسیار مهم است و نباید اتفاق بیفتد. 
...
**لذا تا حد امکان به خصوص در هنگام آپدیت بازی ها از حالت **Pro** برنامه استفاده نکنید.**
...
برای اطلاعات بیشتر راجع به حالت Pro [**اینجا**](https://docs.ezping.ir/how-it-works/pro-mode) را مطالعه کنید.
